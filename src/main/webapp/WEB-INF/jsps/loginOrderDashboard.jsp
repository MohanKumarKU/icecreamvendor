    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="logo" href="index.html"><img src="resources/img/logo.svg" alt="Logo"></a>
        </div>		
      ...
      <div class="container">
        ...
        <div class="row header-info">
          <div class="col-sm-10 col-sm-offset-1 text-center">
            <h1 class="wow fadeIn">Your Order Placed Successfully</h1>
            <br />
            <p class="lead wow fadeIn" data-wow-delay="0.5s">visit again...</p>
            <br />
              ...
              <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
                <div class="row">
                  <div class="col-xs-6 text-right wow fadeInUp" data-wow-delay="1s">
                    <a href="#" class="btn btn-primary">Order Number : ${ordered.id}</a>
                  </div>
    ...
    <section id="be-the-first" class="pad-xl">
      <div class="container">
        ...
        <div class="iphone wow fadeInUp" data-wow-delay="1s">
	        <img src="resources/img/iphone.png">
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row margin-30 news-container">
          <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 wow fadeInLeft" data-wow-delay="0.8s">
            ...
            <img class="news-img pull-left" src="resources/img/press-01.jpg" alt="Tech Crunch">
        ...
        <div class="row margin-30 news-container">
          <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 wow fadeInLeft" data-wow-delay="1.2s">
            <a href="#" target="_blank">
            <img class="news-img pull-left" src="resources/img/press-02.jpg" alt="Forbes">
            <p class="black">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam viverra orci ut. <br /> 
