...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="header">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="col-xs-6">
                    <a href=""><img src="resources/img/logo.svg" alt="Logo" style="background-color: grey;"></a><d>Admin Portal</d>
                </div>
                </div>
                <!-- End Logo -->
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body browser">
                                <p class="f-w-600">Vanilla <span class="pull-right">85%</span></p>
                                <div class="progress ">
                                ...
                                <p class="m-t-30 f-w-600">Chocolate<span class="pull-right">90%</span></p>
                                <div class="progress">
                                ...
                                <p class="m-t-30 f-w-600">Mango<span class="pull-right">65%</span></p>
                                <div class="progress">
                                ...
                                <p class="m-t-30 f-w-600">Strawberry<span class="pull-right">65%</span></p>
                                <div class="progress">
								...
								<p class="m-t-30 f-w-600">Cherry<span class="pull-right">65%</span></p>
                                ...
                                <div class="testimonial-widget-one owl-carousel owl-theme">
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="resources/images/avatar/2.jpg" alt="" />
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="resources/images/avatar/3.jpg" alt="" />
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="resources/images/avatar/1.jpg" alt="" />
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="resources/images/avatar/4.jpg" alt="" />
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="resources/images/avatar/5.jpg" alt="" />
                                            <div class="testimonial-author">TYRION LANNISTER</div>
                                            <div class="testimonial-author-position">Founder-Ceo. Dell Corp</div>
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="resources/images/avatar/6.jpg" alt="" />
                                            <div class="testimonial-author">TYRION LANNISTER</div>
                                            <div class="testimonial-author-position">Founder-Ceo. Dell Corp</div>
								...
								<div class="recent-comment">
									<div class="media">
										<div class="media-left">
											<a href="#"><img alt="..." src="resources/images/avatar/1.jpg" class="media-object"></a>
										</div>
    ...
    <!-- Amchart -->
     <script src="resources/js/lib/morris-chart/raphael-min.js"></script>
    <script src="resources/js/lib/morris-chart/morris.js"></script>
    <script src="resources/js/lib/morris-chart/dashboard1-init.js"></script>


	<script src="resources/js/lib/calendar-2/moment.latest.min.js"></script>
    <!-- scripit init-->
    <script src="resources/js/lib/calendar-2/semantic.ui.min.js"></script>
    <!-- scripit init-->
    <script src="resources/js/lib/calendar-2/prism.min.js"></script>
    <!-- scripit init-->
    <script src="resources/js/lib/calendar-2/pignose.calendar.min.js"></script>
    <!-- scripit init-->
    <script src="resources/js/lib/calendar-2/pignose.init.js"></script>
