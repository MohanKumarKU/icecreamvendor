      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-6 signin text-right navbar-nav">
            <a href="#pricing" class="scroll">Sign up</a>&nbsp; &nbsp;<a href="login">Sign in</a>
          </div>
        </div>
        
        <div class="row header-info">
          <div class="col-sm-10 col-sm-offset-1 text-center">
            <h1 class="wow fadeIn">Snow Ice Cream Vendor</h1>
            <br />
            <p class="lead wow fadeIn" data-wow-delay="0.5s">Feel Cool...</p>
            <br />
